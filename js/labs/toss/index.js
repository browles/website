...
var world = new PhysicsEngine({ origin: new math.Vec3(w/2, 25 + h/2,0)});

window.onresize = function() {
    w = window.innerWidth;
    h = window.innerHeight;
    world.setOrigin(w/2, 25 + h/2,0);
}
...
function BoxView(node, body) {
    ...
    this.node.setProportionalSize(0.90,0.90,0);
    ...
    this.el.setProperty('lineHeight', '300px');
